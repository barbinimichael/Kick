...
***Note that this was built from a previous personal project which can be found at https://github.com/barbinimichael/MavinPlatform***  
## Technologies
...
## Test Configuration
When configured for local build, the server can be found at [localhost:8081](). This can be changed in 
